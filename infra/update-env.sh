...
funcs=("authorization" "show_files" "operate_files" "upload_file" "download_file" "login" "oauth_google_callback" "get_presigned_url")
...
FRONT_URL="https://experiment-lab.link"\,\
